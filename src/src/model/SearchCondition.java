...
public SearchCondition(String spring, String summer, String autumn, String winter, String outer, String jacket,
			...
			String patternNO, String rainOK, String rainNG, String windOK, String windNG) {
		super();
		this.spring = spring;
		this.summer = summer;
		this.autumn = autumn;
